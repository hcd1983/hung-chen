...
$(function () {
	...
	var Products = _barba2.default.BaseView.extend({
		namespace: 'products',
	...
	var Technic = _barba2.default.BaseView.extend({
		namespace: 'technic',
		onEnter: function onEnter() {},
		onEnterCompleted: function onEnterCompleted() {
	...
	_barba2.default.Dispatcher.on('transitionCompleted', function (currentStatus) {
		...
		$("li[data-now]").each(function (i, el) {
	...
	var _transform = new TimelineMax({
		paused: true
	}).add([TweenMax.to($("#transformWrap .box.one"), 0.5, {
		left: 0,
		ease: Power2.easeOut
	...
	var BigFatLp = _barba2.default.BaseTransition.extend({
		start: function start() {
			var _this = this;

			return Promise.resolve().then(function () {
				return _this.newContainerLoading;
			}).then(function () {
